...
using Apstory.Apstorymq.Client.NetStandard.Extention;
using Apstory.Apstorymq.Client.NetStandard.Model;

namespace Apstory.Apstorymq.Client.NetStandard
{
    public class ApstorymqService
    {
        #region Properties
        ...
        public ApstorymqService(string apiUrl, string key, string client, string topic = "", string cipherKey = "")
        {
            _apiUrl = apiUrl;
            _key = key;
            _client = client;
